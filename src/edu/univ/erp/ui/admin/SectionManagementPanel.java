...
public class SectionManagementPanel extends JPanel {
    ...
    // use model index (in case table gets sorted later)
    ...
    String instr = model.getValueAt(modelRow, 2) == null ? "" : model.getValueAt(modelRow, 2).toString(); // shows numeric id or blank
    ...
    // Label changed to indicate numeric PK expected
    ...
    String newInstr = tfInstr.getText().trim(); // numeric string or empty
    ...
    // Validate instructor numeric (if provided)
    ...
    private void deleteSelected() {
        ...
        int c = JOptionPane.showConfirmDialog(this,
                "<html>Are you sure you want to delete section <b>" + sectionId + "</b>?<br/>This will also delete associated enrollments and grades.</html>",
